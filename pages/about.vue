    ...
    <header class="fixed top-0 w-full z-50 bg-white/95 backdrop-blur-md border-b border-gray-200 shadow-sm">
      <div class="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12 py-6 flex items-center justify-between">
        ...
        <nav class="hidden md:flex items-center gap-8 text-sm font-medium">
          ...
          <NuxtLink :to="localePath('organisaties')" class="text-gray-700 hover:text-amber-600 transition-colors">{{ $t('customers.nav') }}</NuxtLink>
          <NuxtLink :to="localePath('prijzen')" class="text-gray-700 hover:text-amber-600 transition-colors">{{ $t('pricing.nav') }}</NuxtLink>
      ...
      >
        <div class="px-6 py-4 space-y-4">
          ...
          <div class="space-y-2">
            ...
            <NuxtLink :to="localePath('organisaties')" @click="closeMobileMenu()" class="block w-full text-left px-3 py-2 text-gray-700 hover:text-amber-600 hover:bg-gray-50 rounded-lg transition-colors">{{ $t('customers.nav') }}</NuxtLink>
            <NuxtLink :to="localePath('prijzen')" @click="closeMobileMenu()" class="block w-full text-left px-3 py-2 text-gray-700 hover:text-amber-600 hover:bg-gray-50 rounded-lg transition-colors">{{ $t('pricing.nav') }}</NuxtLink>
